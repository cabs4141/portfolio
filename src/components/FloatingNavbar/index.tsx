      ...
      >
        {navItems.map((navItem: any, idx: number) => (
          <Link
            ...
            smooth={true}
            duration={500}
            className={cn("cursor-pointer relative dark:text-neutral-50 items-center flex space-x-1 text-neutral-600 dark:hover:text-neutral-300 hover:text-neutral-500 text-sm")}
          >
