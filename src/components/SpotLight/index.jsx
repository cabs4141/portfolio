...
export function SpotLight() {
  ...
  return (
    <div className="flex flex-col items-center xl:h-full sm:h-screen w-full rounded-md flex md:items-center md:justify-center bg-black/[0.96] antialiased bg-grid-white/[0.02] relative overflow-hidden">
